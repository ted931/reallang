                    ...
                    <div style={{ marginTop: 10, textAlign: 'right' }}>
                      <button
                        ...
                        style={{
                          padding: '5px 14px',
                          borderRadius: 99,
                          border: `1px solid ${joined.has(c.id) ? '#10b981' : c.color}`,
                          background: joined.has(c.id) ? '#10b98122' : `${c.color}18`,
                          color: joined.has(c.id) ? '#10b981' : c.color,
                          fontSize: 12,
                          fontWeight: 700,
                          cursor: 'pointer',
                          transition: 'all 0.15s',
