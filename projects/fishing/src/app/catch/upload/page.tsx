    ...
    <div className="max-w-xl mx-auto px-4 py-6 pb-32">
      ...
      <div className="fixed bottom-20 left-0 right-0 z-40 bg-ocean-950/95 border-t border-ocean-800 px-4 py-3 backdrop-blur-sm">
        <div className="max-w-xl mx-auto">
          ...
          <button
            onClick={() => router.back()}
            className="w-full mt-2 py-2.5 font-bold text-sm rounded-2xl border border-ocean-700 text-slate-400 bg-transparent hover:text-slate-200 transition-colors">
            취소
          </button>
        </div>
      </div>
