...
const USER_STEPS = [
  { href: "/", label: "홈", step: 1 },
  { href: "/feed", label: "조황피드", step: 2 },
  { href: "/catch", label: "조황", step: 3 },
  { href: "/catch/upload", label: "조황등록", step: 4 },
  { href: "/match", label: "합동매칭", step: 5 },
  { href: "/booking", label: "예약", step: 6 },
  { href: "/booking/biz1", label: "예약상세", step: 7 },
  { href: "/jwaedae", label: "좌대예약", step: 8 },
  { href: "/rentcar", label: "렌터카", step: 9 },
  { href: "/stay", label: "숙소", step: 10 },
  { href: "/shop", label: "채비주문", step: 11 },
  { href: "/coupon", label: "쿠폰허브", step: 12 },
  { href: "/ranking", label: "랭킹", step: 13 },
  { href: "/analytics", label: "내분석", step: 14 },
  { href: "/tide", label: "물때", step: 15 },
  { href: "/map", label: "포인트지도", step: 16 },
  { href: "/fish-guide", label: "어종도감", step: 17 },
  { href: "/planner", label: "출조플래너", step: 18 },
  { href: "/logbook", label: "낚시일지", step: 19 },
  { href: "/market", label: "중고마켓", step: 20 },
  { href: "/community", label: "커뮤니티", step: 21 },
  { href: "/gathering", label: "동아리", step: 22 },
...
export default function DevNav() {
  ...
  const navContent = (
    <nav className="fixed top-0 left-0 right-0 z-[9999] bg-gray-900 border-b border-gray-800 overflow-x-auto">
