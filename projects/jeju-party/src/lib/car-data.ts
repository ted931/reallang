...
export const RENTAL_STATIONS = [
  "제주공항점", "제주시 연동점", "서귀포점", "중문점", "애월점", "성산점"
] as const;

// Category to recommended car mapping
export const CATEGORY_CAR_MAP: Record<string, string[]> = {
  cycling: ["carnival", "palisade"],
  hiking: ["tucson", "palisade"],
  surfing: ["carnival", "palisade"],
  cafe: ["ray", "avante"],
  food: ["ray", "avante"],
  photo: ["tucson", "sonata"],
  diving: ["tucson"],
  drive: ["sonata", "ev6", "palisade"],
  running: ["ray"],
  fishing: ["carnival"],
  craft: [],
  other: ["ray", "avante"],
