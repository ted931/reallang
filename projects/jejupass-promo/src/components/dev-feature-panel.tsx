...
const STRATEGY = {
  oneLiner: "제주 가게 사장님이 3분 가입으로 AI 홍보 콘텐츠를 자동 생산하고 단체 손님(파티)을 유치하는 B2B 플랫폼",
  phases: [
    {
      label: "초기 (0~6개월)",
      color: "emerald",
      title: "공급 확보 + SEO 씨앗",
      goal: "가게가 없으면 여행자가 안 온다. 공급을 먼저 쌓는다.",
      items: [
        "제주 카페·맛집·체험 업체 300곳 무료 등록 유도",
        "가게당 AI SNS 홍보글 자동 생성 → 가게 이름+카테고리 키워드 SEO 누적",
        "사업자 인증 완료 가게에 '제주패스 인증' 뱃지 부여 → 신뢰도 강화",
        "카페패스 입점 10곳 확보 → 여행자에게 실제 혜택 제공 시작",
        "가게 상세 페이지 → Schema.org JSON-LD → 구글 리치 스니펫 노출",
      ],
    },
    {
      label: "중기 (6~18개월)",
      color: "blue",
      title: "수익화 + 파티 연계",
      goal: "가게가 매출을 올리면 유료 전환한다. 파티로 단체 손님을 보낸다.",
      items: [
        "사장님 유료 플랜 출시 — 기본(무료) / 스탠다드(월 3만) / 프리미엄(월 10만)",
        "jeju-party 파티 참가자 → 파티 연계 가게 자동 노출 (앱간 교차 전환)",
        "카페패스 입점 가게 50곳 → 여행자 방문 데이터 사장님 대시보드 제공",
        "가게 리뷰 2,000건 누적 → 롱테일 SEO 자동 생성",
        "유료 사장님 50명 · MRR 150만원",
      ],
    },
    {
      label: "장기 (18개월~)",
      color: "violet",
      title: "제주 상권 인프라",
      goal: "사장님이 제주패스 없이는 홍보를 못 하는 구조를 만든다.",
      items: [
        "가게별 방문자 통계 · 리뷰 분석 · 경쟁사 비교 대시보드",
        "파티 예약 → 가게 직접 연동 (예약 수수료 3~5%)",
        "제주 관광공사 · 카드사 제휴 → B2B 대형 계약",
  ...
  why: [
    { who: "마케팅 예산 없는 사장님", pain: "배민·카카오 수수료만 나가고 효과 모름", value: "무료 가입 + AI가 매주 인스타 홍보글 자동 생성" },
    { who: "단체 손님이 필요한 업체", pain: "비수기에 손님이 없다", value: "jeju-party 파티 참가자 → 가게 자동 연결" },
    { who: "카페 사장님", pain: "카페패스 입점 절차가 복잡", value: "3분 등록 → 카페패스 자동 입점 신청" },
    { who: "검색 노출이 안 되는 가게", pain: "네이버 플레이스에 묻힌다", value: "가게 상세 페이지 → 구글 롱테일 키워드 자동 SEO" },
  ],
  acquisition: [
    "제주 카페 사장님 모임·에어비앤비 호스트 카페 직접 홍보 (6개월 무료 노출 제안)",
    "당근마켓 제주 지역 광고 — '내 가게 무료 홍보' 소구",
    "네이버 스마트플레이스 연동 — 기존 정보 3초 자동 불러오기로 등록 마찰 제거",
    "가입 완료 즉시 AI 홍보글 1장 바로 생성 → 첫 가치 경험 즉시 제공",
  ],
};
